...
_start:
	...
	call	cstart				;在此函数中改变了，gdt_ptr，让它指向新的GDT
...
csinit:		;这个跳转指令强制使用刚刚初始化的结构——<<OS:D&I 2nd>> P90.
	...
	;ud2    ;UD2是一种让CPU产生invalid opcode exception的软件指令
	;sti
	;push	0
	;popfd		;Pop top of the stack into EFLAGS
	xor		eax,eax
	mov		ax,SELECTOR_TSS
	ltr		ax
...
restart:
	...
	mov		dword [tss + TSS3_S_SP0],eax   ;kernel堆栈指向进程表
restart_reenter:
	dec		dword [k_reenter]	
	pop		gs
	pop		fs
